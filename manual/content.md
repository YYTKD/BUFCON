...
**記法：** `バフ/デバフ名|効果先1,効果先2|簡易メモ|効果|ターン|カラーコード|メモ`
...
<div class="admonition tip">
  <div class="admonition-title">💡 項目の省略</div>
  <div class="admonition-body">
    <p>それ以降の項目をすべて省略する場合は、パイプ（|）をする必要はありません。<br>
    `例：ファイアウェポン|すべての攻撃`
    <br>
    <p>途中の項目だけを省略する場合は、省略する項目分のパイプ（|）を入力してください。<br>
    `ファイアウェポン|すべての攻撃||+1d6||#DF383E`
    <br>※簡易メモとターンとメモを省略
  </div>
</div>
